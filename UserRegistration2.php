...
<p style="text-align: center; color: #FF0004"><strong><em>Password don't match please try again</em></strong></p>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control danger" placeholder="Password *" name="pwd" value="" />
                                        </div>
                                        <div class="form-group">
