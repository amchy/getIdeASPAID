...
<!--  <a class="navbar-brand" href="index.html"><img src="../img/GIPaid_logo.png" width="100px"  alt="GIPaid"></a>-->
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02" align="right">
	...
	<p style="color: #FF0004; text-align: center"><strong><em>Please check your email.</em></strong></p><br><br><br><br>
		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					...
					<form action="logins.php" method="get">
						...
						<div class="input-group mb-2">
							...
							<input type="password" name="fname" class="form-control input_pass" value="" placeholder="password">
						</div>
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
						Don't have an account? <a href="resSelect.php" class="ml-2">Sign Up</a>
					</div>
					<div class="d-flex justify-content-center links">
						<a href="resetPWD.php" style="background: #F39C12">Forgot your password?</a>
					</div>
				</div>
			</div>
		</div>
